...
def register(request):
    if request.method == 'POST':
        ...
        if user_form.is_valid():
            ...
            create_action(new_user, 'has created an account')  # Создание события регистрации пользователя
    ...
    if user_id and action:
        try:
            ...
            if action == 'follow':
                ...
                create_action(request.user, 'is following', user)  # Создание события подписки пользователя
            else:
